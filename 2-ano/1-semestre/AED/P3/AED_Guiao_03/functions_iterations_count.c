...
unsigned int f1(unsigned int n) {         // 1 ciclo for : linear ou logaritmico 
  unsigned int r = 0;
...
unsigned int f2(unsigned int n) {           // dois ciclos : linear logaritmico ou quadratico
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
...
unsigned int f4(unsigned int n) {         //ciclo for triplo = 
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
